...
<tileset version="1.10" tiledversion="1.10.1" name="Entry" tilewidth="32" tileheight="32" tilecount="16" columns="8">
 <image source="../4 Animated objects/Entry.png" width="256" height="64"/>
 <tile id="0">
  <animation>
